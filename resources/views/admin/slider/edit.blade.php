                    ...
                    <div class="tab-content py-3" id="myTabContent">
                        <div class="tab-pane fade show active" id="fa" role="tabpanel" aria-labelledby="farsi-tab">
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="title" class="form-label">عنوان اسلایدر فارسی (متن درون کادر)
                                            :</label>
                            ...
                            <div class="form-group{{ $errors->has('text1') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="title" class="form-label">متن اسلایدر فارسی (متن درشت1) :</label>
...
{{--                </div>--}}
                ...
                <div class="form-group{{ $errors->has('img_top') ? ' has-error' : '' }}">
                    <div class="col-md-12">
                        ...
                        <input type="file" class="form-control" id="img_top" name="img_top" accept="image/*"
                               value="{{ old('img_top') }}"/>
