@component('layouts.admin')
    ...
    @section('body')
        <div class="condition pull-right w-100 mb-2">
            <div class="title">
                <h5><i class="fa fa-trello text-size-large ml-2"></i>افزودن گواهی نامه</h5>
            </div>
            <form action="{{ route('admin_store_certificate') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                <fieldset>
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="pic" class="form-label">   تصویر گواهی نامه :</label>
                    ...
                    <div class="form-group{{ $errors->has('title_en') ? ' has-error' : '' }}">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control d-ltr" id="title_en" name="title_en" value="{{old('title_en')}}" required/>
...
{{--                                <textarea class="textarea ckeditor form-control" id="c_content" name="c_content" cols="30" rows="10">{{ old('c_content') }}</textarea>--}}
