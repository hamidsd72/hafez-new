...
@section('body')
    <div class="condition pull-right w-100 mb-2">
        ...
        <form action="{{ route('admin-blog-store',$type) }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group{{ $errors->has('writer') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="writer" name="writer" value="{{ old('writer','مدیر') }}"
                                               required/>
