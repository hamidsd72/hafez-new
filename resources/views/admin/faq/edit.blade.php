@component('layouts.admin')
    ...
    @section('body')
        <div class="condition pull-right w-100 mb-2">
            ...
            <form action="{{ route('admin-faq-update', $item->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                <fieldset>
...
{{--                                                   value="{{ set_lang($item,'question','en') }}"--}}
{{--                                                   required/>--}}
...
{{--                                                      cols="30"--}}
{{--                                                      rows="10">{{ set_lang($item,'answer','en') }}</textarea>--}}
