@component('layouts.admin')
    ...
    @section('body')
        ...
        @if ( in_array( 'گزارش', explode(",", \App\Models\Permission::where('role_name', auth()->user()->getRoleNames()->first() )->first()->access ) ) || in_array( 'همه', explode(",", \App\Models\Permission::where('role_name', auth()->user()->getRoleNames()->first() )->first()->access ) ) )
