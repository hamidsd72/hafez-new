                            ...
                            <div class="form-group{{ $errors->has('shaba') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="number" class="form-control text-left" dir="ltr" id="shaba" name="shaba" value="{{ old('shaba') }}"/>
                                        @if ($errors->has('shaba'))
                            ...
                            <div class="form-group{{ $errors->has('hesab') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="number" class="form-control text-left" dir="ltr" id="hesab" name="hesab" value="{{ old('hesab') }}"/>
                                        @if ($errors->has('hesab'))
