...
@section('body')
    <div class="condition pull-right w-100 mb-2">
        ...
        <form action="{{ route('admin-about-branch-store') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-control" id="province" name="province">
                                            @foreach ($items as $key => $data)
                                                <option value="{{$data}}" @if($key==0) selected @endif>{{$data}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control text-left" dir="ltr" id="phone" name="phone" value="{{ old('phone') }}" required/>
                                        @if ($errors->has('phone'))
