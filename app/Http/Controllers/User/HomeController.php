...
//        $product_cat_homes=ProductCategory::where('status_home','active')->orderBy('id','desc')->take(4)->get();
        $menu_slider_downs=Menu::where('status','active')->where('slider_down','active')->orderBy('sort_id')->get();
        $about=About::find(1);
        ...
        return view('user.index',compact('sliders','menu_slider_downs','about','products','setting','abouts_f','certs','partners','blogs','contact_info'));
    }
