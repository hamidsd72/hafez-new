...
use App\Club;
use App\Email;
use App\Notifications\AdminCall;
...
class HomeController extends Controller
{
    ...
    {
        $user_permissions   = explode(",",\App\Models\Permission::where('role_name', auth()->user()->getRoleNames()->first() )->first()->access);

        if ( in_array( 'گزارش' , $user_permissions ) || in_array( 'همه' , $user_permissions ) ) {
